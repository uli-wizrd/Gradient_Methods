...
theta = randint(20)  # valor de prueba inicial de x
print("Theta 0 o (x) = ", theta)
theta1 = randint(20)  # valor de prueba inicial de y
...
while True:
 ...
 # El cual es el comando en sympy para realizar la sustitucion, despues .evalf evalua la funcion como si los argumentos
...
if printData:
    ...
    # print('Historial de valores de theta0 (x): ', ptheta, sep=" ")
    print('Historial de valores de theta0 (x):\n ')
    for k in ptheta:
        print(k)
        # print('Historial de valores de theta1 (y): ', ptheta1, sep=" ")
    print('Historial de valores de theta1 (y):\n ')
    for j in ptheta1:
        print(j)
    # print('Historial de valores de la función (z): ', altura, sep=" ")
    print('Historial de valores de la altura (z):\n ')
    for l in altura:
        print(l)

# Gráfica de la función de trabajo

yb = np.linspace(-10, 10, 100)
xb = np.linspace(-10, 10, 100)
